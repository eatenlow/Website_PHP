        ...
        ?>
            <form action="/backend/new_event.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" id=date name="date" value="<?= htmlspecialchars($date) ?>" class="form-control" maxlength="45" required>
                </div>
                ...
                <button class="btn btn-primary" type="submit" name='submit'>Add new Event</button>
            </form>
        </main>
    <?php
